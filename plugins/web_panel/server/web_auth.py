# plugins/web_panel/server/web_auth.py
...
def verify_password_with_hash(password_attempt, stored_hash_b64, salt_b64,
...
def _normalize_token_value(token_candidate):
    """Ensure the token value is always a plain string."""
...
def encode_auth_token():
    try:
        payload = {
            ...
            'iat': datetime.datetime.utcnow(), 'sub': 'admin'
        }
